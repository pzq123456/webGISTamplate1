    ...
    <div class="scroll-section">
      ...
      <div class="scroll-container" ref="scrollContainer">
        ...
        <div class="sticky-graphic" :style="graphicStyle">
          <MapComponent ref="mapRef" :center="viewState.center" :zoom="viewState.zoom" @map-loaded="onMapLoaded" />
        </div>

        <!-- Scroll Steps -->
        <div class="scroll-steps">
          <div v-for="step in steps" :key="step.id" :data-step="step.id" class="step" ref="stepElements">
            <h3>{{ step.title }}</h3>
            <p>{{ step.content }}</p>
          </div>
        </div>
